    ...
    @foreach ($produk as $prod)
        ...
        <form method="POST" action="{{ url('admin/produk/update/' . $prod->id) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="kode" name="kode" type="text" value="{{ $prod->kode }}" class="form-control"
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="nama" name="nama" type="text" value="{{ $prod->nama }}"class="form-control"
                        spellcheck="false" data-ms-editor="true">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="harga_jual" name="harga_jual" type="text"
                        value="{{ $prod->harga_jual }}"class="form-control" spellcheck="false" data-ms-editor="true">
                </div>
            </div>
            <div class="form-group row">
                <label for="harga_beli" class="col-4 col-form-label">Harga Beli</label>
                <div class="col-8">
                    <input id="harga_beli" name="harga_beli" type="text"
                        value="{{ $prod->harga_beli }}"class="form-control" spellcheck="false" data-ms-editor="true">
                </div>
            </div>
            <div class="form-group row">
                <label for="stok" class="col-4 col-form-label">Stok</label>
                <div class="col-8">
                    <input id="stok" name="stok" type="text" value="{{ $prod->stok }}"class="form-control"
                        spellcheck="false" data-ms-editor="true">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="min_stok" name="min_stok" type="text" value="{{ $prod->min_stok }}"class="form-control"
                        spellcheck="false" data-ms-editor="true">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="deskripsi" name="deskripsi" type="text" value="{{ $prod->deskripsi }}"class="form-control"
                        spellcheck="false" data-ms-editor="true">
                </div>
            </div>
            <div class="form-group row">
